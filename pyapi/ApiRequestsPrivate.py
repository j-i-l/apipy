...
class RequestPrivate(Request):
    ...
    def private_session(self, data, params=None, shedule=[], **other_params):  #to do: get rid of the mutable arg
        """ This is for later
            ...
            Arguments:
                ...
                - params: either a dict or a list of dicts with the request 
                    ...
                    as schedule.
                - schedule: list of different conditions to send requests (to do)
    ...
    def _sign(self, params,):
        ...
        """
        h_mac = hmac.new(self.Account.priv_key, digestmod=hashlib.sha512)
        h_mac.update(urllib.urlencode(params)) #dont like the urllib call
